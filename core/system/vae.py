...
class VAESystem(BaseSystem):
    ...
    def test_step(self, batch, batch_idx, **kwargs):
        print('---------------------------------')
        print('Test the Parameter VAE model')
        ae_rec_accs = []
        ...
        print(f'Parameter VAE reconstruction models accuracy:{ae_rec_accs}')
        print(f'Parameter VAE reconstruction models best accuracy:{best_ae}')
        print(f"Parameter VAE reconstruction models average accuracy:{sum(ae_rec_accs) / len(ae_rec_accs)}")
        print(f"Parameter VAE reconstruction models median accuracy:{np.median(ae_rec_accs)}")
        print('---------------------------------')
