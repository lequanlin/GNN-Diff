...
Support GNNs for node classification on small-scaled benchmark homophilic and heterophilic datasets

Results are saved in folder outputs\search\dataset_model_method.csv

"""

from search.search_core_nc import *
import os
...
# Options for model: ['mlp', 'gcn', 'chebnet', 'appnp', 'h2gcn', 'sage', 'gat', 'sgc', 'gpr', 'mixhop']
model = 'gcn'

# Options for dataset:
# Homophilic graphs ['cora', 'citeseer', 'pubmed', 'computers','photo','cs', 'physics']
# Heterophilic graphs ['texas', 'wisconsin', 'cornell', 'actor', 'chameleon', 'squirrel', 'roman-empire', 'amazon-ratings', 'minesweeper', 'tolokers', 'questions']
# dataset = ['cora', 'citeseer', 'pubmed', 'computers','photo','cs', 'wisconsin', 'actor',"roman-empire", "amazon-ratings", "minesweeper", "tolokers"]
dataset = ["cora"]
...
appnp_alpha = [0.1, 0.3, 0.5, 0.7, 0.9] # APPNP teleport alpha #[0.1, 0.3, 0.5, 0.7, 0.9]
h2k = [1, 2, 3] # H2GCN layers
gat_heads = [4, 8, 12] # GAT heads
sgck = [2] #SGC K
